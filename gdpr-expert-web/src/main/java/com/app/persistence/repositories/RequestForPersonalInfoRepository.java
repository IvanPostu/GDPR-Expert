...
public interface RequestForPersonalInfoRepository 
  extends Repository<RequestForPersonalInfoEntity, Long> 
{
  ...
  Page<RequestForPersonalInfoEntity> getAllRequestsForUserOrganisations(
    Long userId, 
    Pageable pageable
  );

  void removeById(Long requestForPersonalInfoId);
